          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
            <div className="bg-white dark:bg-[#222] text-black dark:text-white p-6 rounded-2xl max-w-lg w-full shadow-lg relative">
              ...
              <p className="text-sm leading-relaxed">
                The intention of this app is to allow users to check real-time
                weather conditions by entering a location. Here we are using
                Visual Crossing API to fetch weather data, which furthermore
                caches results via Upstash Redis for faster performance. The
                results shown are detailed metrics including temperature, wind,
                humidity, and more.
              </p>
              <br></br>
              <p className="text-sm leading-relaxed">
                Notice that if a recent location is previously searched, its is
                quicker using redis than a brand new location.
              </p>

              <div className="mt-4 text-sm text-gray-500 dark:text-gray-400">
                Built with Next.js, Tailwind CSS, Upstash Redis, and Visual
                Crossing API.
              </div>
